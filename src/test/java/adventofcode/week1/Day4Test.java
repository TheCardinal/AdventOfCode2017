...
import adventofcode.week1.Day4;
...
public class Day4Test
{
	...
	{
		System.out.println("ASSIGNMENT: " + Day4.numberOfValidPassphrases(ASSIGNMENT));
		System.out.println("ASSIGNMENT v2: " + Day4.numberOfValidPassphrases2(ASSIGNMENT));
	}

	@Test
	public void BonusExamples()
	{
		assertTrue(Day4.isValidBonusPassphrase("abcde fghij"));
		assertFalse(Day4.isValidBonusPassphrase("abcde xyz ecdab"));
		assertTrue(Day4.isValidBonusPassphrase("a ab abc abd abf abj"));
		assertTrue(Day4.isValidBonusPassphrase("iiii oiii ooii oooi oooo"));
		assertFalse(Day4.isValidBonusPassphrase("oiii ioii iioi iiio"));
	}

	@Test
	public void Bonus()
	{
		System.out.println("BONUS: " + Day4.bonus(ASSIGNMENT));
	}

	public final String[] ASSIGNMENT = new String[] { "vxjtwn vjnxtw sxibvv mmws wjvtxn icawnd rprh",
